            ...
            <div class="col-4 offset-4 shadow py-4">
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        <img class="img rounded-circle" style="width: 200px; height: 200px;" src="<?php echo isset($user['profileImage']) ? $user['profileImage'] : './images/profile/beard.png'; ?>" alt="">
                        <h4 class="py-3">
                            <?php
                ...
                <div class="user-info px-3">
                    <ul class="font-ubuntu navbar-nav">
                        ...
                        <li><a href="update_user.php"><button class="btn-warning">Update Profile</button></a></li>
                    </ul>
                </div>
